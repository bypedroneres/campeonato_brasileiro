...
public class MatchesAnalyzer {
    public static void main(String[] args) {
        ...
        // filtrar ano de 2008
        List<Partida> partidas2008 = partidas.stream()
        ...
        List<Partida> partidasEntre2003E2022 = partidas.stream()
        ...
        Map<String, Long> jogosPorEstado = partidasEntre2003E2022.stream()
                .collect(Collectors.groupingBy(Partida::getEstadoJogo, Collectors.counting()));
