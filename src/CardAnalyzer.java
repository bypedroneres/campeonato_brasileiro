...
public class CardAnalyzer {
    public static void main(String[] args) {
        ...
        List<Cartao> listaCartoesAmarelo = cartoes.stream().filter(cartao -> Objects.equals(cartao.getCartao(), "Amarelo")).toList();
        ...
        List<Cartao> listaCartoesVermelhos = cartoes.stream().filter(cartao -> Objects.equals(cartao.getCartao(), "Vermelho")).toList();
        // Agrupar jogadores e contar repeticoes
